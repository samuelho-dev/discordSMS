...
const { DISCORD_TOKEN, DISCORD_GUILD_ID, DISCORD_CLIENT_ID } = config_1.default;
const commands = [];
...
rest
    .put(discord_js_1.Routes.applicationGuildCommands(DISCORD_CLIENT_ID, DISCORD_GUILD_ID), {
    body: commands,
})
